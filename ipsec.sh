...
VPN_IPSEC_PSK='vpn'
VPN_USER='DENDIKUSNANDI'
VPN_PASSWORD='DENDIKUSNANDI'
...
wget -O /usr/bin/addl2tp https://raw.githubusercontent.com/dendikusnandiii/deristaipsec/main/addl2tp.sh && chmod +x /usr/bin/addl2tp
wget -O /usr/bin/dell2tp https://raw.githubusercontent.com/dendikusnandiii/deristaipsec/main/dell2tp.sh && chmod +x /usr/bin/dell2tp
wget -O /usr/bin/xp-l2tp https://raw.githubusercontent.com/dendikusnandiii/deristaipsec/main/xp-l2tp.sh && chmod +x /usr/bin/xp-l2tp
wget -O /usr/bin/addpptp https://raw.githubusercontent.com/dendikusnandiii/deristaipsec/main/addpptp.sh && chmod +x /usr/bin/addpptp
wget -O /usr/bin/delpptp https://raw.githubusercontent.com/dendikusnandiii/deristaipsec/main/delpptp.sh && chmod +x /usr/bin/delpptp
wget -O /usr/bin/xp-pptp https://raw.githubusercontent.com/dendikusnandiii/deristaipsec/main/xp-pptp.sh && chmod +x /usr/bin/xp-pptp
wget -O /usr/bin/renewpptp https://raw.githubusercontent.com/dendikusnandiii/deristaipsec/main/renewpptp.sh && chmod +x /usr/bin/renewpptp
wget -O /usr/bin/renewl2tp https://raw.githubusercontent.com/dendikusnandiii/deristaipsec/main/renewl2tp.sh && chmod +x /usr/bin/renewl2tp
